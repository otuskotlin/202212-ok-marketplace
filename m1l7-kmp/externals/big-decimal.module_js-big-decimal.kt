...
external open class bigDecimal {
    ...
    open fun compareTo(number: bigDecimal): dynamic /* 1 | "-1" | 0 */
    ...
    companion object {
        ...
        fun compareTo(number1: Any, number2: Any): dynamic /* 1 | "-1" | 0 */
